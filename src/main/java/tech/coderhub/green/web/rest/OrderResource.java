...
import tech.coderhub.green.domain.Order;
import tech.coderhub.green.domain.Product;
import tech.coderhub.green.domain.User;
import tech.coderhub.green.repository.OrderRepository;
...
import tech.coderhub.green.service.dto.OrderDTO;
...
/**
 * REST controller for managing {@link tech.coderhub.green.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderResource {
    ...
    public OrderResource(OrderRepository orderRepository, ProductRepository productRepository, UserRepository userRepository) {
    ...
    @PostMapping("/orders-from-mobile")
    public ResponseEntity<Order> createOrderFromMobile(@RequestBody OrderDTO orderDTO) throws URISyntaxException {
        ...
        order.consumerId(user.getId());
        order.sellerId(product.getUserId());
